    ...
    <table class="table table-hover">
      <tbody>
        ...
        <tr>
          <?php
          $co = 1;
            $qry = "select * from book_history inner join event_details on event_details.e_id = book_history.bk_event_id inner join user_profile on user_profile.user_id = book_history.bk_user_id where bk_user_id = ".$_SESSION['id']." and book_history.bk_status = 'failure'";
            $res = $con->query($qry);
            $count = $res->num_rows;
