                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td align="center" st-image="banner-image">
                                          <div class="imgpop">
                                             <a target="_blank" href="<?php echo $base; ?>Show/<?php echo slug($row['title']); ?>/<?php echo $row['e_id']; ?>" title = "check out <?php echo ucwords($row['title']); ?>"><img width="600" border="0" height="180" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="<?php echo $base.$row['banner_img']; ?>" class="banner"></a>
                                          </div>
                                       </td>
                                    </tr>
                                 </tbody>
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #282828; text-align:center; line-height: 24px;">
                                                      Booking details of <?php echo ucwords($row['title']);?>
                                                   </td>
                                                </tr>
                                                <!-- End of Title -->
                                                <!-- spacing -->
                                                ...
                                                <!-- content -->
                                                <tr>
                                                   <td style="  font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #889098; text-align:center; line-height: 24px;">
                                                      <?php echo $tic_details; ?>
                                                   </td>                                             
                                                </tr>
                                                <!-- End of content -->
                                                <!-- Spacing -->
            ...
            <tr>
               <td>
                  <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                     <tbody>
                        <tr>
                           <td align="center" height="30" style="background:#053c6d; color:#fff; font-size:20px; line-height:1px;">Grand Total : <?php echo $_SESSION['price'];?></td>
                        </tr>
                     </tbody>
                  </table>
               </td>
